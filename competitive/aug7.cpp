...
void build_tree(long long node,long long a,long long b){ //node is the index
    ...
    if(a==b){ //updating leaf nodes
        tree[node]=0 ;
        lazy[node]=0 ;//leaf nodes hold array value
        return ;
    }
...
void update_tree(long long node,long long a , long long b,long long i ,long long j){
...
long long t ,n,x,y,z,i,j,k ,l,m,p,f,val,h ;
sld(t) ;
while(t--){
